        ...
        <main className='px-12 mb-32 mt-40 min-h-screen max-w-7xl mx-auto relative'>
            <div className='flex flex-col md:flex-row justify-between'>
                <h1 className='text-[30px] font-bold font-mono text-black dark:text-white'>
                    Welcome To My Blog, <span className='text-Viola'>{author ? `${author.nome} ${author.cognome}` : 'User'}</span>
                </h1>
                <input 
                    type="search" 
                    ...
                    className='border-2 rounded-2xl focus:outline-none focus:ring-2 focus:ring-Viola focus:border-transparent bg-white dark:bg-gray-800 text-black dark:text-white'
                />
            </div>
