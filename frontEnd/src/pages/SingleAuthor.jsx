  ...
  return (
    <div className="flex flex-col items-center min-h-screen mb-10 text-black dark:text-white max-w-7xl mx-auto mt-40">
      <div className="drop-shadow-2xl  mx-auto flex flex-col justify-center items-center gap-4 text-center text-black dark:text-white rounded-full my-5">
        <div className="border-2 border-Viola h-[200px] w-[200px] rounded-full ms-4">
          {author.avatar ? (
            <img
      ...
      {posts.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          ...
          {author.email && <Link to="/create" className="border-2 border-solid border-transparent text-xl font-bold text-white bg-black/30 hover:dark:bg-white/30 hover:bg-Viola/30 hover:border-Viola rounded-xl p-[5px] md:p-[10px] md:px-4 font-mono mt-5 transition-all duration-300 ease-in-out"><button>+ Create your first post</button></Link>}
        </div>
      )}
    </div>
  );
