  ...
  return (
    <div className="mx-auto min-h-screen flex flex-col items-start mt-40 md:grid md:grid-cols-3 text-black dark:text-white">
      ...
      <div className="flex flex-col items-center relative w-full">
          ...
          <Menu as="div" className="absolute right-2 top-7 ">
            <MenuButton>
              <EllipsisVerticalIcon
                className="w-8 h-8 border-2 border-transparent rounded-full hover:border-Viola/50 transition duration-300 ease-in-out"
                aria-hidden="true"
              />
            </MenuButton>
            <Transition
        ...
        <div className="w-full mt-20">
          ...
          >
            ...
            <button
              type="submit"
              className="border border-solid border-black/70 dark:border-white/70 hover:bg-Viola/50 text-black dark:text-white  p-2 w-full transition duration-300 ease-in-out rounded-lg"
            >
              Send Comment
            </button>
          </form>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {editingCommentId === comment._id ? (
                      <form onSubmit={handleCommentUpdate}>
                        ...
                        <button
                          type="submit"
                          className="bg-Viola text-white p-2 mt-2 rounded"
                        >
                          Save
                        </button>
                        <button
                      ...
                      <div>
                        ...
                        {comment.content.length > 100 && (
                          <button
                            ...
                            className="text-Viola hover:underline mt-1 transition-all duration-300"
                          >
                            {expandedComments[comment._id]
                              ? "Show less"
                              : "Show more"}
      ...
      <Link
        ...
        className="flex flex-col items-center gap-3 text-black dark:text-white mb-20 mt-10 md:mt-0 hover:drop-shadow-2xl hover:scale-[1.02] transition duration-300 ease-in-out hover:text-Viola group"
      >
        <h2 className="text-2xl font-semibold font-mono group-hover:text-Viola">Author</h2>
        <img
          className="rounded-full w-[30%] group-hover:text-Viola"
          src={author.avatar || userImg}
          alt={author.nome}
        />
        <h3 className="text-xl font-semibold font-mono group-hover:text-Viola">
