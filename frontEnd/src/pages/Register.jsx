    ...
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 mt-36">
      <div className="w-full max-w-lg p-6 bg-transparent rounded-lg shadow-md text-black dark:text-white">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button type="submit" className="bg-Viola text-white dark:text-black px-4 py-2 rounded-md hover:bg-green-700 mt-4 w-full">Register</button>
        </form>
        <p className="text-center text-gray-500 mt-5">
          Already have an account? <Link to="/login" className="text-Viola hover:text-green-700">Login</Link>
        </p>
      </div>
    </div>
  );
