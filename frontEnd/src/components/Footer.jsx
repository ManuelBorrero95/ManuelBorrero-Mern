  ...
  return (
    <footer className='px-10 py-8 w-full h-96 mt-auto flex flex-col justify-center bg-white dark:bg-black border-t border-gray-200 dark:border-white/30 transition-colors duration-300 relative'>
        <div className='flex flex-col md:flex-row justify-between items-center w-full'>
            ...
            <DarkThemeToggle onClick={toggleDarkMode} className='text-black dark:text-white mt-5 lg:mt-0 hover:border-Viola border-2 border-solid border-transparent hover:bg-transparent transition-all duration-300 ease-in-out lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 '/>
