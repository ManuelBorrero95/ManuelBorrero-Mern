            ...
            {({ open }) => (
                <>
                    <MenuButton className='rounded-full w-12'>
                        {userData.avatar ? (
                            <img className='rounded-full border-2 border-Viola' src={userData.avatar} alt={userData.nome} />
                        ) : (
                            <img className='rounded-full border-2 border-Viola' src={img} alt={userData.nome} />
                        )}
                    </MenuButton>  
                    <AnimatePresence>
                        {open && ( 
                            ...
                            >
                                {dropdownItems.map((item, index) => (
                                    <MenuItem 
                                        ...
                                        className='text-sm p-2 rounded-md hover:bg-[#38495a] hover:text-Viola transition-all duration-300'
                                    >
                                        {item.name}
                                    </MenuItem>
                                ))}
